...
clear; close all
save_dir = 'D:\ProjectAgeingAuditoryTask\heartbeat_evoked_potentials_study\eeg_derivatives_01Hzfilter';
...
%            [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'gui','off'); 
           EEG = eeg_checkset( EEG );
           basefilename = sprintf('eeg_Rpeak_Tpeak_%s', fileList_eeg{k});
