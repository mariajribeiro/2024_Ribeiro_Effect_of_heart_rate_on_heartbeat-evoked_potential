...
% level2_onesample_dir = 'E:\ProjectAgeingAuditoryTask\heartbeat_evoked_potentials_study\LIMO_stats\ECG_grp_task_effect\level2_onesample_ECG_all_participants';

x_axis=-.15:0.002:0.698; % in seconds
figure;
...
for idx = -135:5:325
    plot([idx idx], [-340 250], 'color', [.9 .9 .9], 'LineWidth', 5)
    hold on
end
...
hold on
plot([0 0], [-350 250], '--k',  'LineWidth',1.5) 
hold on
...
box off
ax = gca;
axis([-inf inf -350 250])
ax.LineWidth = 2.5;
ax.FontSize = 28;
ax.FontName = 'Arial';
xlabel('Time (ms)', 'FontSize', 32, 'FontWeight','normal')
ylabel('Amplitude (\muV)', 'FontSize', 32, 'FontWeight','normal')
title('R-locked ECG', 'FontSize', 32, 'FontWeight','normal')
